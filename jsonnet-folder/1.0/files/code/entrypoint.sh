...
main()
{
    ...
    pipelines_dir="/builds/$CI_PROJECT_NAMESPACE/$CI_PROJECT_NAME/cicd-docker/pipelines"

    # Créer un dossier de sortie pour les fichiers YAML générés
    output_dir="/builds/$CI_PROJECT_NAMESPACE/$CI_PROJECT_NAME/cicd-docker/pipelines_yaml"
    mkdir -p "$output_dir"
